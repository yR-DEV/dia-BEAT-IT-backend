...
entry3 = BloodSugarRecord.create(user: user1, blood_sugar: 74, record_time: "preLunch", record_date: '06/03/2019', carbs: 37, insulin_units: 4)
entry4 = BloodSugarRecord.create(user: user1, blood_sugar: 54, record_time: "postLunch", record_date: '06/03/2019', carbs: 35, insulin_units: 1)
